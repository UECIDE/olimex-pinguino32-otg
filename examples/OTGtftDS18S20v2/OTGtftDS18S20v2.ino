/*
  DS18S20 temperature sensor simple test
 
 This example shows how to save data from multiple DS sensors on one pin

 revised  17 January 2016 Anthony Parker
...
void Update_File_Exist(char filename[20],int mF); // update file name, Update_File_Exist(kmlname,1); i.e. kmlname, myFile
void open_txt();
void write_txt();
  ...
  void open_txt()
  {
      myFile1 = SD.open(textname, FILE_WRITE);
          ...
          Serial.print("Writing header to txt file....");
           ...
           myFile1.print(LOG_COLUMN_HEADER);
           myFile1.close();
           delay(50);
          Serial.println("done");
        } else {
